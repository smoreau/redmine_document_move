...
The Document Move plugin is a Redmine plugin which allows to move documents from a project to another. This is done by adding a 'Move' icon in the upper right corner of the document.<br/>
...
This plugin is compatible with Redmine 3.0.x.<br/>
It has been successfully tested on the versions 3.0.1 and 3.0.3.
...
* (C) 2015, Stéphane Moreau (http://www.logikdev.com)
